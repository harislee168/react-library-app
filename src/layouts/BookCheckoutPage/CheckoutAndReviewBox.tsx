...
const CheckoutAndReviewBox: React.FC<{
  book: BookModel | undefined, currentLoansCount: number,
  isAuthenticated: boolean | undefined, isCheckedOut: boolean, hasUserLeftReview: boolean,
  checkoutBookHandler: () => void, postReviewHandler: (rating: number, reviewDescription: string) => void
}> = (props) => {
  ...
  return (
    <div className='card col-3 container d-flex mb-5'>
      <div className='card-body'>
        ...
        {buttonRender({
          isAuthenticated: props.isAuthenticated, currentLoansCount: props.currentLoansCount,
        ...
        {reviewRender({
          isAuthenticated: props.isAuthenticated, hasUserLeftReview: props.hasUserLeftReview,
...
export const CheckoutAndReviewBoxMobile: React.FC<{
  book: BookModel | undefined, currentLoansCount: number,
  isAuthenticated: boolean | undefined, isCheckedOut: boolean, hasUserLeftReview: boolean,
  checkoutBookHandler: () => void, postReviewHandler: (rating: number, reviewDescription: string) => void
}> = (props) => {
